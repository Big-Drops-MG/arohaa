...
type SegmentsPerformanceTableCardProps = {
  title: string
...
function SegmentsPerformanceTableCardBody({
  title,
  table,
  emptyMessage,
  sortByColumnId,
  size = "tall",
}: SegmentsPerformanceTableCardProps) {
  return (
    <Card
      className={cn(
...
export function SegmentsPerformanceTableCard({
  title,
  table,
  ...
  const body = (
    <SegmentsPerformanceTableCardBody
      title={title}
      table={previewTable}
      emptyMessage={emptyMessage}
      sortByColumnId=""
