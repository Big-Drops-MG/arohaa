...
export function LoginPage() {
  ...
  const [showTeamGoogleSignIn, setShowTeamGoogleSignIn] = useState(false)
  ...
  return (
    <AuthScreen>
      <Card className="border-border/80 shadow-sm">
        <CardHeader className="gap-0 pb-2 text-center sm:pb-4">
          <AuthBrandHeader
            title={showTeamGoogleSignIn ? "Team sign in" : "Partner sign in"}
          />
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-5">
            ...
            {!showTeamGoogleSignIn ? (
              <>
                ...
                >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={cn(
                            "h-11 border-neutral-200 bg-white pl-10 text-base shadow-xs md:text-sm",
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={cn(
                            "h-11 border-neutral-200 bg-white pr-11 pl-10 text-base shadow-xs md:text-sm",
                  ...
                  <Button
                    ...
                    className="h-11 w-full text-base font-medium"
                    disabled={
                      !hasBothInputs || isProcessing || isGoogleProcessing
                    }
                    aria-busy={isProcessing}
                  >
                    {isProcessing ? (
                ...
                <p className="text-center text-sm leading-relaxed text-muted-foreground">
                  Are you a member from Big Drops Marketing Group?{" "}
                  <button
                    type="button"
              ...
              <section
                aria-labelledby="internal-sign-in-heading"
                className="space-y-4"
              >
                <form onSubmit={handleGoogleLogin}>
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="h-11 w-full border-neutral-300 bg-white text-base font-medium shadow-xs hover:bg-white"
                    disabled={isProcessing || isGoogleProcessing}
                ...
                <button
                  type="button"
                  className="mx-auto flex items-center gap-1.5 text-sm font-medium text-muted-foreground underline-offset-4 hover:text-foreground hover:underline"
                  onClick={() => {
                    setServerError(null)
                    setShowTeamGoogleSignIn(false)
                  }}
                >
